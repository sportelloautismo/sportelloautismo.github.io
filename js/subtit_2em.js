(function(root, factory) {
	...
	var firstInit = function() {
		...
		style.type      = 'text/css';
		style.innerHTML = ".youtube-external-subtitle { position: absolute; display: none; z-index: 0; pointer-events: none; color: #fff; font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif; font-size: 2em; text-align: center; } .youtube-external-subtitle span { background: #000; opacity:0.2; padding: 1px 4px; display: inline-block; margin-bottom: 2px; margin:300px; } .youtube-external-subtitle.fullscreen-ignore { display: none !important; } .youtube-external-subtitle.fullscreen { z-index: 3000000000; }";
